        ...
        protected function do_plugin_install() {
            ...
            if ( ( isset( $_GET['tgmpa-install'] ) && 'install-plugin' === $_GET['tgmpa-install'] ) || ( isset( $_GET['tgmpa-update'] ) && 'update-plugin' === $_GET['tgmpa-update'] ) ) {
                ...
                if ( $this->is_tgmpa_complete() ) {
                    echo '<p>', sprintf( esc_html( $this->strings['complete'] ), '<br /><br /><a href="' . esc_url( self_admin_url('themes.php') ) . '" class="button button-primary button-hero">' . esc_html__( 'Return to the Theme Installation screen', 'tgmpa' ) . '</a>' ), '</p>';
                    echo '<style type="text/css">#adminmenu .wp-submenu li.current { display: none !important; }</style>';
                } else {
                    echo '<p><a href="', esc_url( $this->get_tgmpa_url() ), '" target="_parent" class="button button-primary button-hero">', esc_html( $this->strings['return'] ), '</a></p>';
                }
            ...
            if ( $this->can_plugin_activate( $slug ) ) {
                ...
                if ( is_wp_error( $activate ) ) {
                    echo '<div id="message" class="error"><p>', wp_kses_post( $activate->get_error_message() ), '</p></div>',
                        '<p><a href="', esc_url( $this->get_tgmpa_url() ), '" target="_parent" class="button button-primary button-hero">', esc_html( $this->strings['return'] ), '</a></p>';
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
    ...
    class TGMPA_List_Table extends WP_List_Table {
        ...
        public function no_items() {
            printf( wp_kses_post( __( 'No plugins to install, update or activate.  <br/><br/><a href="%1$s" class="button button-primary button-hero">Return to the Theme Installation screen</a>', 'tgmpa' ) ), esc_url( self_admin_url('themes.php') ) );
            echo '<style type="text/css">#adminmenu .wp-submenu li.current { display: none !important; }</style>';
        }
                    ...
                    public function bulk_footer() {
                        ...
                        if ( $this->tgmpa->is_tgmpa_complete() ) {
                            ...
                            $update_actions['dashboard'] = sprintf(
                                ...
                                '<br/><br/><a href="' . esc_url( self_admin_url('themes.php') ) . '" class="button button-primary button-hero">' . esc_html__( 'Return to the Theme Installation screen', 'tgmpa' ) . '</a>'
                            );
