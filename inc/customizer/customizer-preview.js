	...
	function updateElementFont (controlName, htmlAddress) {
		wp.customize( controlName, function( value ) {
			value.bind( function( to ) {
				...
				console.info( to );
				console.info( getFontNameByPreset(to) );
				console.info( activeFontFamilyName );

				if( typeof activeFontFamilyName == 'undefined' ) {
					activeFontFamilyName = 'inherit';
				}

				activeFontFamilyName = activeFontFamilyName.replace("+"," ");

				if( activeFontFamilyName != 'inherit' ) {
					activeFontFamilyName = '"' + activeFontFamilyName + '"';
				}
